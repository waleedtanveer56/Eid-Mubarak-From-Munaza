    ...
    <div ref={containerRef} className="relative bg-eid-blue selection:bg-eid-gold selection:text-eid-blue">
        ...
        >
          ...
          <div className="mt-12 pt-8 border-t border-white/10 text-center">
            ...
            <div className="relative inline-block">
              <span className="text-4xl md:text-5xl font-serif font-bold text-eid-gold glow-gold">Sunnaina</span>
              <motion.div 
                initial={{ width: 0 }}
      ...
      <footer className="relative z-10 py-12 border-t border-white/5 text-center bg-black/20 backdrop-blur-sm">
        <p className="text-white/60 font-medium tracking-wide">
          Eid Mubarak • Warm wishes from Sunnaina Tanveer
        </p>
        <p className="text-white/30 text-xs mt-4 uppercase tracking-widest">
          Created with love by Waleed Tanveer
        </p>
      </footer>

      {/* WhatsApp Floating Button */}
      <motion.a
        href="https://wa.me/923009825388?text=Eid%20Mubarak%20Sunnaina!%20Wishing%20you%20a%20joyous%20Eid%20filled%20with%20love%20and%20happiness.%20May%20this%20special%20day%20bring%20you%20peace,%20prosperity,%20and%20countless%20blessings.%20Enjoy%20the%20festivities!🎉"
        target="_blank"
